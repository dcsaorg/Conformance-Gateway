...
public class BookingScenarioListBuilder extends ScenarioListBuilder<BookingScenarioListBuilder> {
  ...
  private BookingScenarioListBuilder thenAllPathsFrom(
    ...
    return switch (bookingState) {
      ...
      case CONFIRMED -> then(
          shipper_GetBooking(bookingState)
              .thenEither(
                  ...
                  uc6_carrier_requestAmendToConfirmedBooking().thenAllPathsFrom(PENDING_AMENDMENT),
      ...
      case PENDING_AMENDMENT -> then(
          shipper_GetBooking(bookingState)
              .thenEither(
                uc6_carrier_requestAmendToConfirmedBooking().thenHappyPathFrom(PENDING_AMENDMENT),
                  uc7_shipper_submitBookingAmendment()
  ...
  private static BookingScenarioListBuilder uc6_carrier_requestAmendToConfirmedBooking() {
    return carrierStateChange(UC6_Carrier_RequestAmendToConfirmedBookingAction::new);
  }
