...
|  |  |
| --- | --- |
| **SupplyCSP [Dry cargo] - UC1 - GET BKG (2xx)** | This scenario verifies that the Shipper can submit and retrieve a Booking request. |
| **SupplyCSP [Dry cargo] - UC1 - UC2 - UC3** | This scenario verifies that the Shipper can submit a Booking update when the Carrier requests an update. |
| **SupplyCSP [Dry cargo] - UC1 - UC5 - UC6 - UC7** | This scenario verifies that the Shipper can submit a Booking amendment when the Carrier requests an amendment. |
...
|  |  |
| --- | --- |
| **SupplyCSP [any BKG] - UC1 - UC5 - UC7 - GET BKG (amended content)** | This scenario verifies that the Shipper can retrieve amended Booking content. |
| **SupplyCSP [any BKG] - UC1 - UC5 - UC7 - UC9** | This scenario verifies that the Shipper can request the cancellation of a Booking amendment. |
| **SupplyCSP [any BKG] - UC1 - UC5 - UC13** | This scenario verifies that the Shipper can request the cancellation of a confirmed Booking. |
| **SupplyCSP [any BKG] - UC1 - UC11** | This scenario verifies that the Shipper can cancel a Booking request. |
...
The complete list of Carrier validations is maintained in the **Carrier Validations** Excel workbook:

20260720 Booking 204 conformance validations - Carrier.xlsx.
...
The complete list of Shipper validations is maintained in the **Shipper Validations** Excel workbook:

20260720 Booking 204 conformance validations - Shipper.xlsx.
