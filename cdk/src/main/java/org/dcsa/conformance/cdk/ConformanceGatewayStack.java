...
public class ConformanceGatewayStack extends Stack {
    public ConformanceGatewayStack(final App parent, final String id) {
        this(parent, id, null);
    }
    ...
    public ConformanceGatewayStack(final Construct parent, final String id, final StackProps props) {
        ...
        Function conformanceLambda = new Function(this, "ConformanceGatewayLambda", FunctionProps.builder()
                ...
                .code(Code.fromAsset("../lambda/", AssetOptions.builder()
                        .bundling(builderOptions
                                ...
                                .build())
                        .build()))
                .handler("org.dcsa.conformance.gateway.DcsaConformanceGatewayLambda")
                .memorySize(1024)
                .timeout(Duration.minutes(15))
                .logRetention(RetentionDays.SEVEN_YEARS)
                .build());

        HttpApi httpApi = new HttpApi(this, "conformance-gateway-api", HttpApiProps.builder()
                .apiName("conformance-gateway-api")
                .build());

        httpApi.addRoutes(AddRoutesOptions.builder()
                .path("/conformance")
                .methods(singletonList(HttpMethod.GET))
                .integration(new HttpLambdaIntegration("ConformanceGatewayIntegration", conformanceLambda, HttpLambdaIntegrationProps.builder()
