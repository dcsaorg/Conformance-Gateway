...
public class CsScenarioListBuilder extends ScenarioListBuilder<CsScenarioListBuilder> {
  ...
  public static LinkedHashMap<String, CsScenarioListBuilder> createModuleScenarioListBuilders(
    ...
    return Stream.of(
                ...
                noAction()
                    .thenEither(
                        ...
                        scenarioWithParametersPtp(
                            ...
                            ARRIVAL_END_DATE),
                        scenarioWithParametersPtp(
                            PLACE_OF_DELIVERY, PLACE_OF_RECEIPT, MAX_TRANSHIPMENT),
                        scenarioWithParametersPtp(
                            PLACE_OF_DELIVERY,
                            PLACE_OF_RECEIPT,
                            DEPARTURE_START_DATE,
                        ...
                        scenarioWithParametersPtp(
                            ...
                            MAX_TRANSHIPMENT),
                        scenarioWithParametersPtp(
                            PLACE_OF_DELIVERY, PLACE_OF_RECEIPT, DELIVERY_TYPE_AT_DESTINATION),
                        scenarioWithParametersPtp(
                            PLACE_OF_DELIVERY, PLACE_OF_RECEIPT, RECEIPT_TYPE_AT_ORIGIN),
                        scenarioWithParametersPtp(
                            PLACE_OF_DELIVERY,
                            PLACE_OF_RECEIPT,
                            DEPARTURE_START_DATE,
            ...
            Map.entry(
                "Port Schedules",
                noAction().thenEither(scenarioWithParametersPs(UN_LOCATION_CODE, DATE))),
            Map.entry(
            ...
            Map.entry(
                ...
                noAction()
                    .thenEither(
                        ...
                        scenarioWithParametersVs(
                            VESSEL_IMO_NUMBER, CARRIER_SERVICE_CODE, CARRIER_VOYAGE_NUMBER),
                        scenarioWithParametersVs(
                            VESSEL_IMO_NUMBER, CARRIER_SERVICE_CODE, UNIVERSAL_VOYAGE_REFERENCE),
                        scenarioWithParametersVs(
                            VESSEL_IMO_NUMBER, UNIVERSAL_SERVICE_REFERENCE, CARRIER_VOYAGE_NUMBER),
                        scenarioWithParametersVs(
                            VESSEL_IMO_NUMBER,
            ...
            Map.entry(
                ...
                noAction()
                    .thenEither(
                        ...
                        scenarioWithParametersVs(
                            CARRIER_VOYAGE_NUMBER, UNIVERSAL_SERVICE_REFERENCE),
                ...
                noAction()
                    .thenEither(
                        ...
                        scenarioWithParametersVsForPagination(
                            getVesselSchedules(), VESSEL_IMO_NUMBER, LIMIT))))
        .collect(
            Collectors.toMap(
