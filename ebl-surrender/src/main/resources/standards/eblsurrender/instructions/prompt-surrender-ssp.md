Please provide the transport document reference and additional info that are required of a EBL_TYPE for which your part can RESPONSE to a surrender request.
