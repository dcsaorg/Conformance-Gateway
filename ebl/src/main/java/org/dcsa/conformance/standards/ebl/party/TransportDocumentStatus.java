...
public enum TransportDocumentStatus {
  ...
  TD_ISSUED("ISSUED"),
  TD_PENDING_SURRENDER_FOR_AMENDMENT("PENDING SURRENDER FOR AMENDMENT"),
  TD_SURRENDERED_FOR_AMENDMENT("SURRENDERED FOR AMENDMENT"),
  TD_PENDING_SURRENDER_FOR_DELIVERY("PENDING SURRENDER FOR DELIVERY"),
  TD_SURRENDERED_FOR_DELIVERY("SURRENDERED FOR DELIVERY"),
  TD_VOIDED("VOID"),
  ;
