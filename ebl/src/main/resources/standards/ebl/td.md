...
* [0. Document metadata](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-0.Documentmetadata)
* [1. What is Conformance?](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-1.WhatisConformance?)

  * [1.1 Scope](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-1.1Scope)
* [2. Conformance Criteria](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-2.ConformanceCriteria)
* [3. Conformance Scenarios](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-3.ConformanceScenarios)

  * [3.1 Carrier Conformance Scenarios](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-3.1CarrierConformanceScenarios)
  * [Required Sea Waybill scenarios](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-RequiredSeaWaybillscenarios)
  * [Required Straight B/L scenarios](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-RequiredStraightB/Lscenarios)
  * [Required Negotiable B/L scenarios](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-RequiredNegotiableB/Lscenarios)
  * [Optional (report-only) scenarios](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-Optional%28report-only%29scenarios)
  * [3.2 Shipper Conformance Scenarios](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-3.2ShipperConformanceScenarios)
  * [Required Sea Waybill scenario](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-RequiredSeaWaybillscenario)
  * [Required Straight B/L scenario](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-RequiredStraightB/Lscenario)
  * [Required Negotiable B/L scenario](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-RequiredNegotiableB/Lscenario)
  * [Optional (report-only) scenarios](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-Optional%28report-only%29scenarios.1)
* [4. Conformance Validations](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-4.ConformanceValidations)

  * [4.1 Scope-defined validations](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-4.1Scope-definedvalidations)
  * [4.2 Carrier Validations](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-4.2CarrierValidations)
  * [4.3 Shipper Validations](#DCSAInterfaceStandardforEBL%28TD%293.x-ConformanceScenarios%28CEP26%29-4.3ShipperValidations)
...
| ------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| Carrier       | Ocean Carrier               | It is mandatory to support all of the following Transport Document capabilities:<br><br>1. Can return the content of draft or issued Transport Documents through **GET** `/v3/transport-documents/{transportDocumentReference}`<br>2. Can accept the approval of draft Transport Documents through **PATCH** `/v3/transport-documents/{transportDocumentReference}`                                                             | May additionally support the following capabilities:<br><br>1. Can send Transport Document notifications by calling the **POST** `/v3/transport-document-notifications` endpoint implemented by the Shipper<br>2. Can receive and process direct Transport Document amendments, through the following endpoints:<br><br>- **PUT** `/v3/transport-documents/{transportDocumentReference}/amendment` to receive a Transport Document amendment request<br>- **GET** `/v3/transport-documents/{transportDocumentReference}/amendment` to return the content of a Transport Document amendment<br>- **DELETE** `/v3/transport-documents/{transportDocumentReference}/amendment` to receive a Transport Document amendment cancellation request | **Document type:**<br><br>- Sea Waybill<br>- Straight BL<br>- Negotiable BL |
| Shipper       | Freight Forwarder / Shipper | It is mandatory to support all of the following Transport Document capabilities:<br><br>1. Can retrieve a draft or issued Transport Document by calling the **GET** `/v3/transport-documents/{transportDocumentReference}` endpoint implemented by the Carrier<br>2. Can approve a draft Transport Document by calling the **PATCH** `/v3/transport-documents/{transportDocumentReference}` endpoint implemented by the Carrier | May additionally support the following capabilities:<br><br>1. Can receive Transport Document notifications from the Carrier through **POST** `/v3/transport-document-notifications`<br>2. Can support Direct Transport Document amendments by calling the following endpoints implemented by the Carrier:<br><br>- **PUT** `/v3/transport-documents/{transportDocumentReference}/amendment` to submit a Transport Document amendment request<br>- **GET** `/v3/transport-documents/{transportDocumentReference}/amendment` to retrieve an amended Transport Document<br>- **DELETE** `/v3/transport-documents/{transportDocumentReference}/amendment` to cancel a Transport Document amendment request                                    | **Document type:**<br><br>- Sea Waybill<br>- Straight BL<br>- Negotiable BL |
...
The complete list of Carrier validations is maintained in the **Carrier Validations** Excel workbook: ![](e65568adc70992f28f321dc6994bf84980396914ee0096a5d7fad4ee9dcc1942).
...
The complete list of Shipper validations is maintained in the **Shipper Validations** Excel workbook: ![](1c53be9f4e17cc3905b56dc821f0f3f9d618d6299ed085f71d41766b0674a7a6).
