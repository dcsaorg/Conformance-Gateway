    ...
    return Stream.of(
                ...
                noAction()
                    .thenEither(
                      scenarioWithParameters(
                        Map.of(CARRIER_SERVICE_NAME,"Great Lion Service")
                      ),
                      scenarioWithParameters(
                        Map.of(CARRIER_SERVICE_NAME,"Blue Whale Service",
                          LIMIT, "1")
                      ),
                      scenarioWithParameters(
                        Map.of(CARRIER_SERVICE_NAME,"Red Falcon Service",
                      ...
                      scenarioWithParameters(
                        Map.of(CARRIER_SERVICE_CODE, "BW1")
                      ),
                      scenarioWithParameters(
                        Map.of(CARRIER_SERVICE_CODE, "BW1",
                          LIMIT, "1")
                      ...
                      scenarioWithParameters(
                        Map.of(UNIVERSAL_SERVICE_REFERENCE, "SR12345A")
                      ),
                      scenarioWithParameters(
            ...
            Map.entry(
              ...
              noAction()
                .thenEither(
                  scenarioWithParameters(
                    Map.of(VESSEL_IMO_NUMBER, "9456789")
                  ),
                  scenarioWithParameters(
                    Map.of(VESSEL_IMO_NUMBER, "9876543", LIMIT, "1")
                  )
                )),
            Map.entry(
              "Location schedules",
              noAction()
                .thenEither(
                  scenarioWithParameters(
                    Map.of(UN_LOCATION_CODE, "NLAMS")
                  ),
                  scenarioWithParameters(
                    Map.of(UN_LOCATION_CODE, "USNYC", LIMIT, "1")
                  ),
                  scenarioWithParameters(
                    Map.of(FACILITY_SMDG_CODE, "APM")
                  ),
                  scenarioWithParameters(
                    Map.of(FACILITY_SMDG_CODE, "APM", LIMIT, "1")
                  )
                )),
            Map.entry(
              "Voyage schedules",
