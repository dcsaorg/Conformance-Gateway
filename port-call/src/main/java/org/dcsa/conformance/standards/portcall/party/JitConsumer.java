...
public class JitConsumer extends ConformanceParty {
  ...
  protected Map<Class<? extends ConformanceAction>, Consumer<JsonNode>> getActionPromptHandlers() {
    return Map.ofEntries(
        ...
        Map.entry(PortCallGetAction.class, this::sendGetActionRequest));
  }
  ...
  private void sendGetActionRequest(JsonNode actionPrompt) {
    ...
    JitGetType getType =
        JitGetType.valueOf(actionPrompt.required(PortCallGetAction.GET_TYPE).asText());
    List<String> filters =
        OBJECT_MAPPER.convertValue(actionPrompt.get(PortCallGetAction.FILTERS), List.class);
