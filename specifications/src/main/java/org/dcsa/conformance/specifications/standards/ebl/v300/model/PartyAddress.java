...
public class PartyAddress {
  ...
  @Schema(description = "The name of the street of the party’s address.", example = "Ruijggoordweg", maxLength = 70)
  ...
  @Schema(description = "The city name of the party’s address.", example = "Amsterdam", maxLength = 35, pattern = "^\\S(?:.*\\S)?$")
  private String city;
