...
public class AcceptSurrenderRequestAction extends EblSurrenderV10Action {
  public AcceptSurrenderRequestAction(
  ...
  public boolean trafficExchangeMatches(ConformanceExchange exchange) {
    ...
    return stringAttributeEquals(requestJsonNode, "surrenderRequestReference", srr)
        && stringAttributeEquals(requestJsonNode, "action", "SURR");
  }
}
