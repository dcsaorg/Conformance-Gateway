...
public class AttributeMapping {
  ...
  private static void addShipmentEventTypeCodeMappings(
    ...
    attributeMappings.put(
        ...
        List.of(
            new AttributeMapping(
                "shipmentEventTypeCode",
                (node, value) -> !node.isMissingNode() && node.asText().equals(value),
                Set.of(
                    "RECE", "DRFT", "PENA", "PENU", "REJE", "APPR", "ISSU", "SURR", "SUBM", "VOID",
                    "CONF", "REQS", "CMPL", "HOLD", "RELS"))));
  }

  private static void addDocumentTypeCodeMappings(
      Map<String, List<AttributeMapping>> attributeMappings) {
    attributeMappings.put(
        DOCUMENT_TYPE_CODE,
        List.of(
  ...
  private static void addEquipmentTypeCodeMappings(
      Map<String, List<AttributeMapping>> attributeMappings) {
    attributeMappings.put(
        "equipmentTypeCode",
        List.of(
            new AttributeMapping(
                ...
                (node, value) -> !node.isMissingNode() && node.asText().equals(value),
                Set.of(
                    "LOAD", "DISC", "GTIN", "GTOT", "STUF", "STRP", "PICK", "DROP", "INSP", "RSEA",
                    "RMVD"))));
  }
  ...
  private static void addTransportEventTypeCodeMappings(
      Map<String, List<AttributeMapping>> attributeMappings) {
    attributeMappings.put(
  ...
  private static void addTransportCallIDMappings(
      Map<String, List<AttributeMapping>> attributeMappings) {
    attributeMappings.put(
        "transportCallID",
        List.of(
  ...
  private static void addExportVoyageNumberMappings(
      Map<String, List<AttributeMapping>> attributeMappings) {
    attributeMappings.put(
        "exportVoyageNumber",
        List.of(
  ...
  private static void addEventCreatedDateTimeMappings(
      Map<String, List<AttributeMapping>> attributeMappings) {
    attributeMappings.put(
        ...
        List.of(
            new AttributeMapping(
                ...
                (node, value) ->
                    !node.isMissingNode()
                        && OffsetDateTime.parse(node.asText()).isEqual(OffsetDateTime.parse(value)),
                Set.of())));
    ...
    attributeMappings.put(
        ...
        List.of(
            new AttributeMapping(
                ...
                (node, value) ->
                    !node.isMissingNode()
                        && (OffsetDateTime.parse(node.asText()).isAfter(OffsetDateTime.parse(value))
                            || OffsetDateTime.parse(node.asText())
                                .isEqual(OffsetDateTime.parse(value))),
                Set.of())));

    attributeMappings.put(
        "eventCreatedDateTime:gt",
        List.of(
            new AttributeMapping(
                EVENT_CREATED_DATE_TIME,
                (node, value) ->
        ...
        List.of(
            new AttributeMapping(
                ...
                (node, value) ->
                    !node.isMissingNode()
                        && OffsetDateTime.parse(node.asText())
                            .isBefore(OffsetDateTime.parse(value)),
                Set.of())));

    attributeMappings.put(
        "eventCreatedDateTime:lte",
        List.of(
            new AttributeMapping(
                EVENT_CREATED_DATE_TIME,
                (node, value) ->
  ...
  private static void addCarrierBookingReferenceMappings(
      Map<String, List<AttributeMapping>> attributeMappings) {
    attributeMappings.put(
        ...
        List.of(
            new AttributeMapping(
                ...
                (node, value) ->
                    !node.isMissingNode()
                        && node.path("documentReferenceType").asText().equals("BKG")
            ...
            new AttributeMapping(
                ...
                (node, value) ->
                    !node.isMissingNode()
                        && node.path(DOCUMENT_TYPE_CODE).asText().equals("BKG")
                        && node.path("documentID").asText().equals(value),
                Set.of())));
  }

  private static void addEquipmentReferenceMappings(
      Map<String, List<AttributeMapping>> attributeMappings) {
    attributeMappings.put(
        "equipmentReference",
        List.of(
            ...
            new AttributeMapping(
                ...
                (node, value) ->
                    !node.isMissingNode()
                        ...
                        && node.path("referenceValue").asText().equals(value),
                Set.of())));
  }

  private static void addTransportDocumentReferenceMappings(
      Map<String, List<AttributeMapping>> attributeMappings) {
    attributeMappings.put(
