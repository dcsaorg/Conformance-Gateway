...
public class TntDataSets {
  ...
  static final Set<String> VALID_DOCUMENT_REFERENCE_TYPE_CODES =
      Set.of(
          "AMF", "ARN", "BKG", "CAS", "CBR", "CEA", "CEO", "CQU", "CRO", "CUC", "DEI", "DEO", "DGD",
          "FCE", "HCE", "ICE", "INV", "OOG", "PCE", "PFD", "SHI", "TRD", "TRO", "VCE", "VGM");

  static final Set<String> VALID_TRANSPORT_EVENT_TYPE_CODES = Set.of("ARRI", "DEPA");

  static final Set<String> VALID_EQUIPMENT_EVENT_TYPE_CODES =
      Set.of(
          "AVDO", "AVPU", "CROS", "CUSI", "CUSR", "CUSS", "DISC", "DROP", "GTIN", "GTOT", "INSP",
          "LOAD", "PICK", "RMVD", "RSEA", "STRP", "STUF");

  static final Set<String> VALID_IOT_EVENT_TYPE_CODES = Set.of("DETC");

  static final Set<String> VALID_IOT_EVENT_CODES = Set.of("DRC", "DRO", "LOC");

  static final Set<String> VALID_REEFER_EVENT_TYPE_CODES = Set.of("MEAS", "ADJU");
}
