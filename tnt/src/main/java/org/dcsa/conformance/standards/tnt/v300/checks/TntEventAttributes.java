...
@UtilityClass
public class TntEventAttributes {
  ...
  static final String TRANSPORT_EVENT_TYPE_CODE = "transportEventTypeCode";
  ...
  static final String EQUIPMENT_EVENT_TYPE_CODE = "equipmentEventTypeCode";
  static final String EQUIPMENT_DETAILS = "equipmentDetails";
  static final String EQUIPMENT_REFERENCE = "equipmentReference";
  static final String ISO_EQUIPMENT_CODE = "ISOEquipmentCode";
  static final String IOT_EVENT_TYPE_CODE = "iotEventTypeCode";
  static final String IOT_DETAILS = "iotDetails";
  static final String IOT_EVENT_CODE = "iotEventCode";
  static final String REEFER_EVENT_TYPE_CODE = "reeferEventTypeCode";
  static final String REEFER_DETAILS = "reeferDetails";
}
